...
<div class="d-flex justify-content-center">
<h1 style="color:#03989E; font-family: 'Caveat Brush', cursive;" >Register As A Vet!</h1>
...
<div class="container d-flex justify-content-center" style="border-weight=5px">
 <form action="clinic_details.jsp" method="post">
	...
	color:#03989E;">Specialization</label>
      <div class="col-sm-9">
	...
	color:#03989E;">Phone Number</label>
      ...
      <button type="submit" class="btn btn-primary" style="background-color:#03989E;">Next</button>
